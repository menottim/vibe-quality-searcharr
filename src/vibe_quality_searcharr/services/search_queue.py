"""
Search Queue Management Service for Vibe-Quality-Searcharr.
...
from vibe_quality_searcharr.core.security import decrypt_api_key
from vibe_quality_searcharr.models import Instance, SearchHistory, SearchQueue
